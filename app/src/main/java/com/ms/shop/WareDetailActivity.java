...
import com.ms.shop.utils.CartProvider;
...
//  TODO      mWebView.loadUrl(Contants.API.WARES_DETAIL);
        mWebView.loadUrl("file:///android_asset/detail.html");
...
// 分享时Notification的图标和文字  2.5.9以后的版本不调用此方法
        ...
        oks.setTitleUrl("http://www.amumu.com");
...
//        oks.setImagePath("/sdcard/test.jpg");//确保SDcard下面存在此张图片
        ...
        oks.setSiteUrl("http://www.amumu.com");
